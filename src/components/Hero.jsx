    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-center gap-3">
          <span className="inline-flex items-center gap-2 rounded-full bg-blue-50 dark:bg-[#030712] border border-blue-200 dark:border-[#155dfc]/40 px-4 py-1.5 text-sm font-semibold text-blue-950 dark:text-white shadow-sm">
            <Star className="h-4 w-4 fill-blue-600 dark:fill-[#50a2ff] text-blue-600 dark:text-[#50a2ff]" />
            <span>4.9 from 100+ Enterprise Clients</span>
          </span>
          <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 dark:bg-[#030712] border border-blue-200 dark:border-[#50a2ff]/40 px-4 py-1.5 text-sm font-semibold text-blue-700 dark:text-[#50a2ff] shadow-sm">
            <Globe2 className="h-4 w-4 text-blue-700 dark:text-[#50a2ff]" />
        ...
        <h1 className="mb-6 text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl lg:text-6xl">
          ...
          <span className="bg-gradient-to-r from-[#155dfc] via-[#2563eb] to-[#50a2ff] dark:from-[#50a2ff] dark:to-[#93c5fd] bg-clip-text text-transparent">Enterprise AI &amp; Digital Products</span>
        </h1>

        {/* Subtitle with High Contrast */}
        <p className="mx-auto mb-8 max-w-2xl text-lg text-slate-700 dark:text-gray-300 sm:text-xl leading-relaxed font-normal">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <NoiseButton
            href="/contact-us"
            className="w-full sm:w-auto text-base font-semibold min-h-[48px]"
          >
        ...
        <div className="mt-8 flex items-center justify-center gap-4 text-sm text-slate-600 dark:text-gray-300 font-medium">
      ...
      <div className="mt-16 border-t border-b border-gray-200 dark:border-white/[0.08] bg-gray-50/90 dark:bg-[#030712]/80 backdrop-blur-md px-4 py-6">
        <div className="mx-auto grid max-w-5xl grid-cols-2 gap-6 lg:grid-cols-4">
          <div className="flex items-center justify-center gap-2.5 text-gray-800 dark:text-gray-200 text-sm font-semibold">
            <span className="text-[#155dfc] dark:text-[#50a2ff]">
