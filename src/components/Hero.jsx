    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 dark:bg-[#030712] border border-blue-200 dark:border-[#50a2ff]/40 px-4 py-1.5 text-sm font-semibold text-blue-800 dark:text-sky-300 shadow-sm">
            <Globe2 className="h-4 w-4 text-blue-800 dark:text-sky-300" />
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg text-slate-800 dark:text-gray-200 sm:text-xl leading-relaxed font-normal">
